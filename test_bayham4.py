"""Quick Selenium test on Bayham's Laserfiche December 2024 folder."""
import time
...
url = "https://laserfiche.bayham.on.ca/WebLink/Browse.aspx?id=535262&dbid=0&repo=BAYHAM"
print(f"Loading: {url}")
driver.get(url)
time.sleep(5)

soup = BeautifulSoup(driver.page_source, "html.parser")
print("\nLinks in Dec 2024 folder:")
