...
# ---------- OUTPUTS ----------
BUILD_DIR = r"C:\OFA\bylaw_maps\build_beta"
UPPER_PARQUET = os.path.join(BUILD_DIR, "upper_single_map_beta.parquet")
LOWER_PARQUET = os.path.join(BUILD_DIR, "lower_single_map_beta.parquet")
