"""Quick Selenium test on Bayham's Laserfiche Council folder."""
import time
...
url = "https://laserfiche.bayham.on.ca/WebLink/Browse.aspx?id=444365&dbid=0&repo=BAYHAM"
print(f"Loading: {url}")
driver.get(url)
time.sleep(5)

soup = BeautifulSoup(driver.page_source, "html.parser")
print("\nLinks in Council folder:")
